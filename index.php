...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Thief Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Thief Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/dcc/thief/"  class="text_link" target="_blank"><span class="bold">Dwarves, Thiefs & Mighty Deeds: A DCC Fan Site</span></a></p>

        <p><a href="https://www.tasaka-games.com/dcc/more/classes/thief/"  class="text_link" target="_blank"><span class="bold">Fantastic Adventures and the Distgruntled Gong Farmer: A DCC Adventure Module</span></a></p>
    ...
    <div id="characterNameV3">
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#ThiefFormV3").attr('action', "character3/dccThief.php");
